# Android Fourth Endpoint (Mobile Terminal)

> Fact snapshot: 2026-08-17. Status: `[UNVERIFIED]` — no capability is claimed
> before the Termux verification passes.

[中文](android-endpoint.md) · [Reality Gate](reality-gate.en.md)

## Positioning

Android is the **fourth community endpoint** of the DSH community distribution
(alongside WSL/Linux Terminal, Windows Desktop, macOS Desktop). The product
...
pattern as the rest of the Suite. No Agent loop reimplementation.
...
```bash
# inside Termux
git clone https://github.com/kamanager2012/deepseek-harness-suite.git
cd deepseek-harness-suite && bash scripts/termux-verify.sh
```
