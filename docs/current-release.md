...
| Latest tested | `0.1.2-alpha.4` — consolidated acceptance PASS ([run 33576016696](https://github.com/kamanager2012/dsh-community/actions/runs/33576016696)); compatibility evidence only, not publication |
