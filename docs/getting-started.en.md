...
| Download a desktop build | [Community Releases](https://github.com/kamanager2012/dsh-community/releases) | Use Preview for testing; do not call Windows/macOS Stable before the three-OS gate is green |
