...
| This repo [`archive/deepseek-harness-suite/`](https://github.com/kamanager2012/dsh-community/tree/main/archive/deepseek-harness-suite) (formerly `deepseek-harness-suite`) | Archived Labs | Frozen; do not install |
...
Suite and the former standalone Marketplace, Plugins registry, and Edition repositories were merged into this repository and deleted. None is a second Runtime or client.
